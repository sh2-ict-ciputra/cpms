...
class CreateTenderKorespondensisTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $set_schema_table = 'tender_korespondensis';

    /**
     * Run the migrations.
     * @table tender_korespondensis
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["tender_rekanan_id"], 'tender_korespondensis_tender_rekanan_id_index');
            $table->softDeletes();
