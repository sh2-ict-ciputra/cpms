...
class CreateBudgetTahunanDetailtemplatesTable extends Migration
{
     ...
     * @var string
     */
    public $set_schema_table = 'budget_tahunan_detailtemplates';

    /**
     * Run the migrations.
     * @table budget_tahunan_detailtemplates
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["template_id"], 'budget_tahunan_detailtemplates_template_id_index');

            $table->index(["itempekerjaan_id"], 'budget_tahunan_detailtemplates_itempekerjaan_id_index');

            $table->index(["budget_id"], 'budget_tahunan_detailtemplates_budget_id_index');
            $table->softDeletes();
