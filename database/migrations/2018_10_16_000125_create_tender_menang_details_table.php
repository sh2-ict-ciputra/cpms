...
class CreateTenderMenangDetailsTable extends Migration
{
     ...
     * @var string
     */
    public $set_schema_table = 'tender_menang_details';

    /**
     * Run the migrations.
     * @table tender_menang_details
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->index(["itempekerjaan_id"], 'tender_menang_details_itempekerjaan_id_index');

            $table->index(["templatepekerjaan_detail_id"], 'tender_menang_details_templatepekerjaan_detail_id_index');

            $table->index(["tender_menang_id"], 'tender_menang_details_tender_menang_id_index');
            $table->softDeletes();
