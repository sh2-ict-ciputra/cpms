...
class CreateTenderRekanansTable extends Migration
{
     ...
     * @var string
     */
    public $set_schema_table = 'tender_rekanans';

    /**
     * Run the migrations.
     * @table tender_rekanans
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->integer('is_recomendasi')->nullable()->default(null);

            $table->index(["tender_id", "rekanan_id"], 'tender_rekanans_tender_id_rekanan_id_index');
            $table->softDeletes();
