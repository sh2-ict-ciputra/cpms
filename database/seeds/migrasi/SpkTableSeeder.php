...
class SpkTableSeeder extends Seeder
{
    ...
    public function run()
    {
	    ...
	    while(! feof($file)){
	    	...
	    	if ( $csv_line != "" ) {
                $pt = \Modules\Pt\Entities\Pt::find(25);
                $no_wo = \App\Helpers\Document::new_number('WO', 2,60).$pt->code;
                ...
                $workorder->no = $no_wo;
                $workorder->budget_tahunan_id = 66;
                ...
                $workorder->created_at = date("Y-m-d H:i:s.u");
                ...
                $approval_workorder->created_at = date("Y-m-d H:i:s.u");
                ...
                $workorder_detail->created_at = date("Y-m-d H:i:.u");
                ...
                $workorder_budget_detail->created_at = date("Y-m-d H:i:s.u");
                $workorder_budget_detail->created_by = 1;
                $workorder_budget_detail->save();
                /*==================================================================================================*/

                //Save to RAB
                $no_rab = \App\Helpers\Document::new_number('RAB', 2,60).$pt->code;
                ...
                $approval_tender->created_at = date("Y-m-d H:i:s.u");
                ...
                if ( $rekanan->count() > 0 ){
                    ...
                    $rekanan_group->created_at = date("Y-m-d H:i:s.u");
                    ...
                    $rekanans->created_at = date("Y-m-d H:i:s.u");
                    $rekanans->save();
                ...
                $approval_tender_rekanan->created_at = date("Y-m-d H:i:s.u");
                ...
                foreach ($tender->rab->units as $key => $value) {                    
                    ...
                    $tender_unit->created_at = date("Y-m-d H:i:s.u");  
                    $tender_unit->save();
                }
                ...
                foreach ($tender->rekanans as $key => $value) {
                    for ( $i=0; $i < 3; $i++ ){
                        ...
                        $tender_penawaran->created_at = date("Y-m-d H:i:s.u");  
                        ...
                        foreach ($tender->rab->pekerjaans as $key => $value) {
                            ...
                            $tenderpenawarandetail->created_at = date("Y-m-d H:i:s.u");  
                    ...
                    foreach ($tender->units as $key2 => $value2) {
                        ...
                        $tender_menang->created_at = date("Y-m-d H:i:.u");
                        $tender_menang->save();  
                    }    
                    ...
                    foreach ($tender->rab->pekerjaans as $key => $value) {
                        ...
                        $tender_menang_detail->created_at = date("Y-m-d H:i:s.u");  
                        $tender_menang_detail->save();
                    }  

                    $no_spk = \App\Helpers\Document::new_number('SPK', 2,60);
                    ...
                    foreach ($tender->units as $key2 => $value2) {
                        ...
                        $unit_progress->volume = "1";
                        $unit_progress->satuan = "ls";
                        $unit_progress->nilai = $csv_line[8];
                    ...
                    $item_progress = $spk_now->progresses->first()->itempekerjaan->item_progress;
