            ...
            <div class="col-md-12">
              ...
              <button type="submit" class="btn btn-primary">Simpan</button>
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="penawaran2_date" class="form-control" name="penawaran2_date" value="" autocomplete="off" style="width:150px" required>
                </div>
                <div class="form-group">
                  <label>Tanggal Klarifikasi Kedua </label>
                  <input type="text" id="klarifikasi2_date" class="form-control" name="klarifikasi2_date" value="" autocomplete="off" style="width:150px" required>
                </div>
