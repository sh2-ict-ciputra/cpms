                                ...
                                <tr class="test_child">
                                    ...
                                    <td style="text-align:right;width : 10%">
                                      @if ($value3->volume_admin == null )
                                        <input type="text" class="form-control child_volume_admin" name="" value="{{$value3->volume}}" style="width:100%">
                                        1
                                      @else
                                        <input type="text" class="form-control child_volume_admin" name="" value="{{$value3->volume_admin}}" style="width:100%">
                                        2
                                      @endif
                                    </td>
                                    <td style="width : 5%">
