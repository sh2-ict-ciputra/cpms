    ...
    <div class="panel panel - default">
        ...
        <div class="panel-body pull-right">
            ...
            <table style="width: 100%;margin-top:20px;">
                ...
                <tr>
                    <td style="text-align: left;">Bersama ini kami {{strtoupper($korespondensi->tender_rekanan->tender->rab->pt->name)}} mengundang perusahaan saudara untuk mengikuti proses Aanwidjzing untuk pekerjaan <strong>{{$korespondensi->tender_rekanan->tender->name}}</strong></td>
                </tr>
                <tr>
            ...
            <table style="width: 100%;margin-top:20px;">
                ...
                @if ($korespondensi->tender_rekanan->tender->harga_dokumen != 0)
                    <tr>
                        <td style="text-align: left;">No. rek</td>
                        <td style="text-align: left;">: {{$norek}}
                        </td>
                    </tr>
                @endif
            </table>
