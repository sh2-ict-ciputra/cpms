          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">                  
                  ...
                  <a class="btn btn-info" href="{{ url('/')}}/report/document/budget/?id={{ $project->id }}">Budget</a>
                  <a class="btn btn-primary" href="{{ url('/')}}/report/document/pekerjaan/?id={{ $project->id }}">Pekerjaan</a>
                </div>
