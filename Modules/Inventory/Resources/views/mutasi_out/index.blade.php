...
<div class="panel panel-success">
  <div class="panel-heading"><a href="{{ url('/inventory/mutasi_out/index') }}"><strong>Daftar Mutasi Out</strong></a></div>
  <div class="panel-body">
  	<a href="{{ url('/inventory/mutasi_out/add') }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		genTable = $('#table_master').DataTable(
			{
				  processing: true,
		          ajax: "{{ url('/inventory/mutasi_out/getData') }}",
		          columns:[
		...
		sBody.on('click','.detail',function()
		{
			...
			window.location.href="{{ url('/inventory/mutasi_out/details/') }}"+"/"+data.id;
		});
