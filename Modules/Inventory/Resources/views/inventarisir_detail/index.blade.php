...
<div class="wrapper">
  ...
  <ul class="breadcrumb">
			            ...
			            <li>
			            	<a href="{{ url('/inventory/barang_keluar/index').'?id='.$inventarisirDetailCollections->first()->inventarisir->barangkeluar->permintaanbarang_id }}">Barang Keluar ...</a>
			            </li>
			            <li>
			            	<a href="{{ url('$inventarisirDetailCollections->first()->inventarisir->barangkeluar->id') }}">Mutasi IN {{ $inventarisirDetailCollections->first()->inventarisir->no}}</a>
			            </li>
			            <li>
			            	<span>Pembentukan Asset</span>
			            </li>
			        </ul>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<hr />
			...
			@if(is_null($inventarisirDetailCollections->first()->inventarisir->barangkeluar_id))
				@include('form.a',
					[
						'href' => url('/inventory/inventarisir/index'),
						'caption' => 'Kembali'
					])
			@else
				@include('form.a',
					[
						'href' => url('/inventory/inventarisir/index').'?id='.$inventarisirDetailCollections->first()->inventarisir->barangkeluar_id,
						'caption' => 'Kembali'
					])
			@endif
			<hr/>
