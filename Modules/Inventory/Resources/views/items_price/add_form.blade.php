        ...
        <div class="col-xs-12">
          <div class="box">
             <ul class="breadcrumb">
                  ...
                  <li>
                  	<a href="{{ url('/inventory/items_price/index').'?id='.$items->id }}">Harga : {{ $items->item->name }}</a>
                  </li>
                   <li>
            ...
            <div class="box-body">
              <div class="col-md-12">
              	<strong>Tambah Harga : {{ $items->item->name }}</strong>

              	@include('form.a',[
						'href'=> url('/inventory/items_price/index').'?id='.$items->id,
					...
					<hr/>
<form method="post" id="id-SaveForm" action="{{ url('/inventory/items_price/create') }}" class="form-horizontal">
	{{ csrf_field() }}
	<input type='hidden' id='item_id' name='item_id' class='form-control' style='width:50%' value='{{ $items->id }}' />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Daftar Harga : {{ $items->item->name }}</h4>
      </div>
