	...
	<div class="panel panel-success">
      ...
      <a href="{{ url('/inventory/mutasi_in/index') }}" class="btn btn-primary pull-right"><i class="fa fa-mail-reply"></i> Kembali</a>
        ...
        <li role="presentation" class="active">
          <a href="#tab_karyawan" data-toggle="tab">Individu</a>
        </li>
		  </ul>
        ...
        <canvas  id="myCanvas"  width="896" height="504" style="display: none;"></canvas>
			...
			<div id="tab_karyawan" class="tab-pane fade in active">
				<br/>
				<form action="{{ url('/inventory/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_karyawan" autocomplete="off">

		         {{ csrf_field() }}
             <input type="hidden" name="mutasiin_source" id="mutasiin_source" value="employee" />
             <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Pemberi</label>
...
var fnCheckBox = function(trParent,item_id)
{
	...
	$(document).ready(function()
  {
    ...
    on('change','.input-satuan',function()
    {
     ...
     $('#from_karyawan').submit(function(e){
        e.preventDefault();
        var dataNotinsert = '';
