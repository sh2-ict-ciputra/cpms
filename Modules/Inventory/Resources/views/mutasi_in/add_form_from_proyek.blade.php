...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="panel panel-success">
      ...
      <div id="tab_proyek" class="tab-pane fade in active ">
        <br/>
        <form action="{{ url('/inventory/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_proyek" autocomplete="off">

             {{ csrf_field() }}
             <input type="hidden" name="mutasiin_source" id="mutasiin_source" value="project" />
	...
	$(document).ready(function()
  {
    ...
    on('change','.input-satuan',function()
    {
      ...
      var engine = new Bloodhound({
                    ...
                    queryTokenizer: Bloodhound.tokenizers.whitespace,
                    remote: {
                          url: '/inventory/mutasi_in/projectTypeaHead?q=%QUERY%',
                          wildcard: '%QUERY%'
                      }
                  });
