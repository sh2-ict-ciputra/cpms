...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="panel panel-success">
      ...
      <a href="{{ url('/mutasi_in/index') }}" class="btn btn-primary pull-right"><i class="fa fa-mail-reply"></i> Back</a>
	  	<ul class="nav nav-tabs" id="mytabs">
		  <li role="presentation" >
		  	<a href="#tab_scan" data-toggle="tab">Gambar</a>
		  </li>
      <li role="presentation" class="active">
        <a href="#tab_karyawan" data-toggle="tab">Karyawan</a>
      </li>
      <li role="presentation">
        <a href="#tab_proyek" data-toggle="tab">Proyek</a>
      </li>
      <li role="presentation">
        <a href="#tab_rekanan" data-toggle="tab">Rekanan</a>
      </li>
      <li role="presentation">
        ...
        <canvas  id="myCanvas"  width="896" height="504" style="display: none;"></canvas>
			...
			<div id="tab_karyawan" class="tab-pane fade in active">
				<br/>
				<form action="{{ url('/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_karyawan" autocomplete="off">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                  <button class="btn btn-success" id="btn-item" type="button"><i class="fa fa-bars"></i> ADD</button>
              </div>
            </div>     
      ...
      <div id="tab_proyek" class="tab-pane fade">
        <br/>
        <form action="{{ url('/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_proyek" autocomplete="off">
      ...
      <div id="tab_rekanan" class="tab-pane fade">
        <br/>
        <form action="{{ url('/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_rekanan" autocomplete="off">

             {{ csrf_field() }}
             <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Rekanan</label>
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="input-group">
                  <input type="hidden" name="id_pic_giver" value="0" id="id_pic_giver" />
                  <input type="text" name="giver" id="giver" class="form-control typeaHead" />
      ...
      <div id="tab_other" class="tab-pane fade">
        <br/>
        <form action="{{ url('/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_other" autocomplete="off">
...
var fnInsert = function(obj)
{
	...
	$(document).ready(function()
  {
    ...
    on('change','.input-satuan',function()
    {
     ...
     fnInsert('#from_karyawan');
     fnInsert('#from_proyek');
     fnInsert('#from_rekanan');
     fnInsert('#from_other');
