...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="panel panel-success">
      ...
      <a href="{{ url('/inventory/mutasi_in/index') }}" class="btn btn-primary pull-right"><i class="fa fa-mail-reply"></i> Back</a>
      ...
      <div id="tab_rekanan" class="tab-pane fade in active">
        <br/>
        <form action="{{ url('/inventory/mutasi_in/create') }}" method="post" class="form-horizontal form-label-left" id="from_rekanan" autocomplete="off">
          <input type="hidden" name="mutasiin_source" id="mutasiin_source" value="rekanan" />
             {{ csrf_field() }}
    ...
    on('change','.input-satuan',function()
    {
     ...
     //lookup source
      var engine = new Bloodhound({
                    ...
                    queryTokenizer: Bloodhound.tokenizers.whitespace,
                    remote: {
                          url: '/inventory/getRekanan/type_rekanan?q=%QUERY%',
                          wildcard: '%QUERY%'
                      }
                  });
