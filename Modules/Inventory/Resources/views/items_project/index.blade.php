		...
		gentable = $('#table_data').DataTable(
		{
        	...
        	"columns":[
                  	...
                  	{ data: 'satuan',name:'satuan',"bSortable": false},
	                {
	                  ...
	                  " <button class='price btn btn-primary btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='left' title='Harga'><i class='fa fa-dollar'></i></button>"+
	                  ...
	                  " <button class='delete btn btn-danger btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='top' title='Hapus'><i class='fa fa-trash-o'></i></button>" +
	                  " <button class='btn-detail-items btn btn-warning btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='right' title='Detail'><i class='fa fa-list'></i></button>"+
	                  "</div>"
	            	}
          	],
