...
<div class="panel panel-success">
  <div class="panel-heading"><strong>Approval Mutasi Out</strong></div>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    ...
    gentable = $('#table_master').DataTable({
          ...
          processing: true,
          ajax: "{{ url('/inventory/hod_inventory/getListApprovalMutasiOut') }}",
          columns:[
                 ...
                 { data: 'destination',name: 'destination',"className":"text-center","bSortable": false},
    ...
    tBody.on('click','.approve',function(){
        ...
        var mutasiout_id = data.id;

        var _datasend = {'id':mutasiout_id,_token:$('input[name=_token]').val()};
    ...
    on('click','.details',function(){
        var data =  gentable.row($(this).parents('tr')).data();
        var mutasiout_id = data.id;
        window.location.href="{{('/hod_inventory/detailsMutasiOut')}}"+"/"+mutasiout_id;
    });
