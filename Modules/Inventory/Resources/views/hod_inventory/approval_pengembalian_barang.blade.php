  ...
  $(document).ready(function()
  {
    ...
    gentable = $('#table_data').DataTable(
    {
      //scrollY:        "300px",
        ...
        //paging:         false,
          processing: true,
          ajax: "{{ url('/inventory/hod_inventory/getListApprovalPengembalianbarang') }}",
          columns:[
                 { data: 'nomor',name: 'nomor',"bSortable": false},
                 { data: 'no',name: 'no',"bSortable": false},
                 { data: 'nomor_pengembalian',name: 'nomor_pengembalian',"bSortable": false},
                ...
                { data: 'item_satuan',name: 'item_satuan','sClass': 'text-right',"bSortable": false},
                {
                  ...
                  "<button class='approve btn btn-primary btn-xs' rel='tooltip' data-toggle='tooltip' data-placement='left' title='Approve'><i class='fa fa-check-square'></i></button> "+
                ...
                api.column(1, {page:'current'} ).data().each( function ( group, i ) {
                    if ( last !== group ) {
                        $(rows).eq( i ).before(
                            ...
                            "<td colspan='6' style='text-align:left;padding:10px;'><strong> Nomor Refrensi : "+group+"</strong></td>"+
                            "<td class='text-right'>"+
                            "</td></tr>");
                            last = group;
                    }
