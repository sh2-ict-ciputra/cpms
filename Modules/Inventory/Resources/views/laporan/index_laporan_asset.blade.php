  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <ul class="breadcrumb">
                  ...
                  <li>
                      <span>Penyusutan Aktiva Tetap</span>
                  </li>
              </ul>
            <!-- /.box-header -->
            <div class="box-body">
   ...
   <div class="panel panel-success">
      ...
      <div class="panel-body">
       <form class="form-inline" method="post" action="{{ url('/inventory/asset/printReport') }}" id="form_cetak">
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    ...
    gentable = $('#table_master').DataTable({
          ...
          paging:false,
          processing: true,
          ajax: "{{ url('/inventory/asset/getPenyusutanAsset') }}",
          columns:[
