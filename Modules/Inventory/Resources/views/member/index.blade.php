					...
					<div class="tab-content">
						  <div id="tab_list" class="tab-pane fade in active">
							...
							<div id="tab_add" class="tab-pane fade">
								<form action="{{ url('/inventory/member/store') }}" method="post" class="form-horizontal form-label-left" id="form_data" autocomplete="off">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		gentable = $('#table_data').DataTable({
	        ...
	        paging:         false,
			  processing: true,
	          ajax: "{{ url('/inventory/member/getData') }}",
	          columns:[
		...
		on('click','.delete',function()
		{
				...
				buttons: {
					deleteUser: {
						...
						action: function () {
							$.post("{{ url('/inventory/member/delete') }}", 
							{
								id:id,
								_token: token
							}, 
