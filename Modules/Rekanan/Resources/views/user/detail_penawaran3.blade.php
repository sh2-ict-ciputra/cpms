                ...
                <tbody>
                  ...
                  @foreach( $tenderRekanan->penawarans as $key => $value )
                    ...
                    <tr>
                      ...
                      <td><input type="text" name="input_rab_nilai_[{{ $key3}}]"  id="input_rab_nilai_{{ $key3}}" class="form-control vol" onKeyUp="showSummary('{{ $key3}}')" style="text-align: right;" value="{{ number_format($value3->nilai,2) }}"></td>
