              ...
              <div class="col-md-8">
                <!-- <form action="{{ url('/')}}/progress/input-siknonbiaya" method="post"> -->
                  <div class="form-group">
                    ...
                    <textarea class="form-control" style="height: 33px;min-width: 250px; margin: 0px; min-height: 250px; max-height: 350px; height: 250px; max-width: 350px width: 350px;" rows="7" id="isian1" name="isian" readonly>{{ $sik->sik_detail[0]->keterangan }}</textarea>
                  </div>
                <!-- </form> -->
              </div>
            </div>
