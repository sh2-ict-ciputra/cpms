            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="">
                    <table class="table">
                      <thead>
                        <tr>
                          <th>Nomor PO</th><th>{{$PO_umum[0]->no}}</th>
                        </tr>
                        <tr>
                          <th>Nomor Tender</th><th>{{$PO_umum[0]->tender_menang->tender->no}}</th>
                        </tr>
                        <tr>
                          <th>Nomor Penawaran</th><th>{{ $PO_umum[0]->tender_menang->penawaran->no }}</th>
                        </tr>
                         <tr>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="">
                    <table class="table">
                      <thead>
                          <tr>
                            <th>Jumlah Total Item</th><th>{{$jumlah_seluruh_item[0]->quantity}}</th>
                          </tr>
                          <tr>
                            <th>Jumlah Seluruh Item Diterima</th><th>{{$PBPO2[0]->quantity}}</th>
                          </tr>
                          <tr>
                            <th>Jumlah Sisa Item</th><th>{{$sisa_total_item}}</th>
                          </tr>
                      </thead>
                    </table>
                </div>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border" style="height: 50px">
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-primary" onclick="location.href='{{ url('/')}}/access/penerimaanbarangPO/detail/approve/?id={{ $value->PBPO_id }}'">
                          <i class="fa fa-fw fa-check"></i> Approve 
                </button>
                <button type="button" class="btn btn-danger" onclick="location.href='{{ url('/')}}/access/penerimaanbarangPO/detail/reject/?id={{ $value->PBPO_id }}'">
            ...
            <div class="box-body">
              <table class="table">
                <thead>
                  ...
                  ?>
                  <tr>
                    <th>Jumlah Item Diterima</th><th>{{$jumlah_diterima[0]->quantity}}</th>
                  </tr>
                  <tr>
                ...
                <table id="ListTelahKelompok" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                    <thead style="background-color: greenyellow;">
                      <tr >
                        ...
                        <th class="text-right">Volume Di terima</th>
                        <th>Gudang</th>
  ...
  $.ajaxSetup({
    ...
    $(document).ready(function()
    {
        $('.btn-approve').click(function()
        {
            ...
            var _url = "{{ url('/access/penerimaanbarangPO/detail/approve') }}";
