                ...
                <div class="box-header">
                  <table class="table" style="font-size:18px; width: 100%;">
                    <tr>
                      ...
                      <td>:</td>
                      <td>{{$spk->tender->rab->budget_tahunan->budget->pt->name}}</td>
                    </tr>
                    <tr>
                      <td>No. SPK</td>
                      <td>:</td>
                ...
                <table  class="table" style="font-size:15px; width: 100%; ">
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      @if ( $key->termin == "1" || $spk->progress_sebelumnya == 100)
                      0 %
                      @else
                        {{$spk->retensis->sum('percent')*100}}%
                      @endif
                    </td>
                    ...
                    <td style="text-align: center;">{{(float)$key->pph*100}}%</td>\
