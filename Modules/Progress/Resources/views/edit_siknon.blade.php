          ...
          <div class="box">
            ...
            <div class="col-md-6">   
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="hidden" name="id_spk" id="id_sik" value="{{$sik->sik_detail[0]->id}}">
              ...
              <div class="col-md-8">
                <!-- <form action="{{ url('/')}}/progress/input-siknonbiaya" method="post"> -->
                  <div class="form-group">
                    ...
                    <textarea class="form-control" style="height: 33px;min-width: 250px; margin: 0px; min-height: 250px; max-height: 350px; height: 250px; max-width: 350px width: 350px;" rows="7" id="isian1" name="isian">{{ $sik->sik_detail[0]->keterangan }}</textarea>
                  </div>
                  <div class="form-group">
                    <center>
                      <button type="button" class="btn btn-primary submitbtn" id="btn_submit">Update</button>
                    </center>
                  </div>
                <!-- </form> -->
              </div>
...
<script type="text/javascript">
  $(function () {
   ...
   function input(){
      var _url = '{{ url("/")}}/progress/update-siknonbiaya';
      // var idipk = $('#yes').val();
