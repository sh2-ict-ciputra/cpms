                            ...
                            <td> 
                              ...
                              @if($ipk != 0)
                                ...
                                {{-- @if ($key->pengajuan != null)
                                  ...
                                  @endif
                                @else
                                  Rekanan Belum mengajukan Pengajuan IPK
                                @endif --}}
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    function input(){
      var _url = '{{ url("/")}}/progress/simpan-progress';
